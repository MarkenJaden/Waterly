...
namespace Waterly.Utils
{
    public class NotificationManager
    {
        ...
        private void ScheduleDrinkReminder(DateTime when, string tag)
        {
            ...
            var toastContent = new ToastContent()
            {
                ...
                Audio = new()
                {
                    Src = (App.Settings.NotificationSetting == Settings.NotificationLevel.Standard) ?
                        new("ms-appx:///Assets/Sounds/waterdrop_sound.wav") :
            ...
            var toast =
                new ScheduledToastNotification(toastContent.GetXml(), new(when))
                {
                    // Set expiration time
        ...
        private void ScheduleSleepReminder(DateTime when)
        {
            ...
            var toastContent = new ToastContent()
            {
                ...
                Audio = new()
                {
                    Src = new("ms-appx:///Assets/Sounds/sleep_soothing_sound.wav"),
                    Loop = false
                },
