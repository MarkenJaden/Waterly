...
namespace Waterly
{
    public sealed partial class PersonPage : Page
    {
        ...
        private void AgeTextBox_Apply(object sender, RoutedEventArgs args)
        {
            ...
            var ageValue = int.Parse(textBox.Text, CultureInfo.InvariantCulture);
        ...
        private readonly Regex weightRegex = new("^\\d*([\\.,]\\d?)?$");
        ...
        private void WeightTextBox_Apply(object sender, RoutedEventArgs args)
        {
            ...
            var weightValueStr = textBox.Text.Replace(',', '.');
            ...
            // Parse the content of the TextBox
            var weightValue = float.Parse(weightValueStr, CultureInfo.InvariantCulture);
        ...
        private readonly Regex heightRegex = new("^\\d*([\\.,]\\d{0,2})?$");
        ...
        private void HeightTextBox_Apply(object sender, RoutedEventArgs args)
        {
            ...
            var heightValueStr = textBox.Text.Replace(',', '.');
            ...
            // Parse the content of the TextBox
            var heightValue = float.Parse(heightValueStr, CultureInfo.InvariantCulture);
